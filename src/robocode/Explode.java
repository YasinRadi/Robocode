...
public class Explode extends ImageObject{
	    // Image of animation.
...
//    public Explote(String animImage, int frameWidth, int frameHeight, int numberOfFrames, long frameTime, boolean loop, int x, int y, long showDelay){
     ...
     public Explode(String animImage, int frameWidth, int frameHeight, int numberOfFrames, long frameTime, boolean loop, int x, int y, long showDelay){ 
        super(x,y,0,0,0,true,animImage);
        this.animImage = super.getImg();
